...
const profileSchema=mongoose.Schema({
    ...
    first_name:{type:String,required:false,minlength:0,maxlength:15,trim:true},
    ...
    Covid_condition:{type:String,required:false,minlength:0,maxlength:15,trim:true},
    Allergies:{type:String,required:false,minlength:0,maxlength:115,trim:true},
    Medications:{type:String,required:false,minlength:0,maxlength:115,trim:true},
    Prior_surgeries:{type:String,required:false,minlength:0,maxlength:115,trim:true},
    Medical_conditions:{type:String,required:false,minlength:0,maxlength:115,trim:true},
    Additional_notes:{type:String,required:false,minlength:0,maxlength:115,trim:true},
    Primary_physician:{type:String,required:false,minlength:0,maxlength:15,trim:true},
    Additional_contacts:{type:String,required:false,minlength:0,maxlength:15,trim:true},
